...
- The project documentation (including guides, specifications, and explanatory text) is licensed under CC BY‑NC‑SA 4.0.
- The source code and executable files are distributed under a custom MIT‑style license with strict non‑commercial conditions.
- This dual licensing is intentional: it enforces openness for learning and sharing, while preserving strict control over protocol use and naming
